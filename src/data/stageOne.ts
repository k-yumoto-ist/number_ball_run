...
export const STAGE_ONE: StageData = {
  ...
  track: [
    ...
    { id: 'narrow', zStart: 72, zEnd: 89, width: 4.2, centerStart: -0.9, centerEnd: -0.45 },
  ...
  gaps: [{ id: 'g-1', x: 1.05, z: 55, width: 2.45, depth: 4.6 }],
}
